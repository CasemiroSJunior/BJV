...
export default function Layout() {
    ...
    const handleDrawerUse = (event: string) => {
        console.log(event)
        if (auth) {
            if (event === "userCreate") router.push('/users/userCreate');
            if (event === "vacancy") router.push('/vacancy/VacancyList');
            if (event === "tips") router.push('/misc/Advices');
            if (event === "newVacancy") router.push('/vacancy/register/vacancyRegister');
                                    ...
                                    <div className='bg-DefaultRedBoldEtec h-full'>
                                        ...
                                        <Grid className='mt-4'>
                                            <Grid alignContent='center'>
                                                ...
                                                <Grid>
                                                    <Button onClick={() => handleDrawerUse('userCreate')} name='profile' size='large' variant="outlined" className='w-52 mt-2 space-x-2 border rounded-lg p-2 m-3 border-EtecGrayText hover:border-zinc-800  hover:bg-DefaultHoverBoldEtec text-base text-EtecLightGray hover:text-white'>
                                                        Cadastrar Usuário
                                                    </Button>
                                                </Grid>
                                                <Grid>
